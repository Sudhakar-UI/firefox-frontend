...
import { Container, Nav, Tab, InputGroup, Form, Button, Image, Modal, NavDropdown } from "react-bootstrap";
								...
								<div className="login-form">
									<div className="loginformbox">
										...
										<div className="logbottomcellbox">
											<p className="btngray"><Link href="/signin" className="ms-1 t-blue" id="login"><i className="fa fa-long-arrow-left me-2"></i> Back to Sign in </Link>
											</p>
										</div>
									</div>
