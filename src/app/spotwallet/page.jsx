				...
				<Container className="sitecontainer">
					...
					<div className="boxtabb tabrightbox">
						<Nav className="nav nav-tabs tabbanner border-0" role="tablist">
							<Nav.Item className="nav-item"><Nav.Link as={Link} href="/spotwallet" className="active">Spot</Nav.Link></Nav.Item>
							<Nav.Item className="nav-item"><Nav.Link as={Link} href="/featureswallet">Features</Nav.Link></Nav.Item>
