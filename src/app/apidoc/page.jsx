...
import { faInfoCircle, faCopy } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <article className="innerpage">
                ...
                <section className="innercontentpage">
                    <Container>
                        <h2 className="heading-title text-center pb-0 mb-0">API Documentation</h2>
                    </Container>
                </section>
                <section className="apipagedoc">
                    <Container>
                                ...
                                <div className="panelcontentbox getapikey-y">
                                    <div className="leftsidenavtab">
                                        <Nav className="nav nav-tabs tabbanner border-0" role="tablist">
                                            <Nav.Item><Nav.Link eventKey="tab1">Getting API keys</Nav.Link></Nav.Item>
                                            ...
                                            >
                                                ...
                                                {/* <NavDropdown.Item onClick={handleItemClick}><Nav.Link eventKey="tab8">Creating a QR-Codes</Nav.Link></NavDropdown.Item> */}
                                    ...
                                    <Form className="siteformbg">
                                        <Tab.Content>
                                            <Tab.Pane eventKey="tab1">
                                                <h2 className="heading-title">Getting API keys</h2>
                                            ...
                                            <Tab.Pane eventKey="tab4">
                                                ...
                                                <div className="copyapicodeb">
                                                    ...
                                                    <pre className="highlight plaintext">
                                                        ...
                                                        <code>
                                                            <span>
                                                                <span className="highlight-span">Post: </span>
                                                                {`https://api.heleket.com/v1/paymentPost 
                                                                    https://api.heleket.com/v1/paymentPost 
                                                                    https://api.heleket.com/v1/paymentPost 
                                                                    https://api.heleket.com/v1/paymentPost 
                                                                    https://api.heleket.com/v1/paymentPost 
