        ...
        <>
            <div className='cpytrade'>
                ...
                <section className="copytradetopsection savingbannersec ieobannerbg">
                    <Container>
                        <Row className="align-items-center feacpy-y">
                            <Col lg={7} md={7}>
                                <p className="mb-0"><Link href="#" className="alink"><FontAwesomeIcon className='me-2' icon={faArrowLeft} /><span className="t-black">Portfolios List</span></Link></p>
