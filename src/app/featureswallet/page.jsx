		...
		<div className="pagecontent gridpagecontent innerpagegrid">
			...
			<div className="innerpagecontent">
				<Container className="sitecontainer">
					<h2 className="h2">Features Wallet</h2>
					<div className="boxtabb tabrightbox">
						<Nav className="nav nav-tabs tabbanner border-0" role="tablist">
							...
							<Nav.Item className="nav-item">
								<Nav.Link as={Link} href="/featureswallet" className="active">Features</Nav.Link></Nav.Item>
									<Nav.Item className="nav-item"><Nav.Link as={Link} href="/demowallet">Demo wallet</Nav.Link></Nav.Item>
					...
					<div className="panelcontentbox">
						<div className="wlltpageblnce">
							<div className="balanceshowt totblance d-flex align-items-center">
								<div>
									<h5>Features balances<span className="ps-2"><FontAwesomeIcon icon={faEye} /></span></h5>
								...
								<div className="text-end">
									<Image src="assets/images/personalact1.svg" alt="icon" withd={20} height={20} />
								</div>
							</div>
						</div>
					</div>
