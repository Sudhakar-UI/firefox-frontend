...
const SpotCopyTrade = () => {
    ...
    return (
        <div className='copymodules'>
            <Homeheader />
            <section className="savingbannersec ieobannerbg spotcpy-y">
                <Container>
                    <Row className="row align-items-center">
                        <Col lg={6}>
                            ...
                            <div className="join-as-y">
                                <Link href='#' id='joinbtn' className='btn sitebtn my-2'>Join as a Lead Trader</Link>
                            </div>
                        </Col>
            ...
            <section className="twotablesec copytwotabsec">
                <div className="container" data-aos="fade-up" data-aos-duration="1000">
                    <div className="markettabflex">
                        <Nav activeKey="/spot-copy-trade" className="nav nav-tabs" role="tablist">
                            <Nav.Item className="nav-item">
                                <Nav.Link id='futureslink' href="/futures-copy-trade" className="nav-link nav-link-y-pnl">Futures</Nav.Link>
                            </Nav.Item>
                            <Nav.Item className="nav-item">
                                <Nav.Link id='spotlink' className="nav-link nav-link-y-pnl" href="/spot-copy-trade">Spot</Nav.Link>
                            </Nav.Item>
                        </Nav>
                    </div>
                    <div className="cpytradibox pt-3">
                        <h2 className="heading-title">Spot Copy Trading</h2>
                        <p>Unlock the potential of top crypto traders-mirror their moves with a single click and watch your portfolio thrive.</p>
                                ...
                                <div className="">
                                    <div className="table-content">
                                        ...
                                        <div className="needhelpcontent">
                                            ...
                                            <p className="content">Trade, automate, or copy strategies on Firefox Trader Spot and earn from a $100,000 USDC reward pool with exclusive loss protection.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="">
                                    <div className="table-content">
                                        ...
                                        <div className="needhelpcontent">
                                            ...
                                            <p className="content">Step into elite trading
                                                Get rewarded with up to 30% profit share
            ...
            <section className="balancesec pt-2">
                <div className="container">
                    ...
                    <div className="cpytradeovr text-start mt-4 align-items-center">
                        ...
                        <div className="cpytradediv border-0">
                               <Button className="borderbtn btn-sm">view all<FontAwesomeIcon icon={faChevronRight} className="ms-2"/></Button>
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item as="div">
                                        <Form.Check type="checkbox" label="Hide Full Portfolios" />
                                    </Dropdown.Item>
                                    <Dropdown.Item as="div">
                                                        ...
                                                        <div className="panelcontentbox p-0">
                                                            <Table id='table2' className="table sitetable">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colSpan={2}><Link href="/spot-copy-trade-2" className="btn sitebtn herobtn">Copy</Link></td>
                                                                    </tr>
                                                                </tbody>
                                                            </Table>
                                                        </div>
                                                        ...
                                                        <div className="panelcontentbox p-0">
                                                            <Table id='table4' className="table sitetable">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colSpan={2}><Link href="#" className="btn sitebtn herobtn">Copy</Link></td>
                                                                    </tr>
                                                                </tbody>
                                                            </Table>
                                                        </div>
                        ...
                        <div className="p2pfaq" data-aos="fade-up" data-aos-duration="1000">
                            <Accordion activeKey={activeKey} flush>
                                ...
                                >
                                    <div className="inside"></div>
                                    <Accordion.Header>
                                        Are my funds secure on Firefox TRADER?
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry's
