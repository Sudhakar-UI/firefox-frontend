...
import { Container, Image, OverlayTrigger, Tooltip, Table, Form, Modal, Row, Col, Button, InputGroup, Badge, Tab, Nav, Dropdown } from 'react-bootstrap';
...
const Page = () => {
    ...
    const extraCoins = ["LOC", "DOGE", "XRP", "ADA", "BNB"];
                                ...
                                <div className="crytb-y">
                                    ...
                                    <div>
                                        <h5 className="h5">
                                            <Link
                                                href="/buysell"
                                                className={`nav-link ${pathname === '/buysell' ? 'active' : ''}`}
                                            >
                                                Buy/Sell
                                            </Link>  </h5>
                                    </div>
