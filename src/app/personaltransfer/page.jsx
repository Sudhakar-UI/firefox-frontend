            ...
            <Container className="sitecontainer">
                ...
                <div className="boxtabb tabrightbox">
                        <Nav className="nav nav-tabs tabbanner border-0" role="tablist">
                            ...
                            <Nav.Item className="nav-item"><Nav.Link href="/personaltransfer" className="active">Transfer</Nav.Link></Nav.Item>
                        </Nav>
                    </div>
            </Container>
        </div>
          ...
          <div className="panelcontentbox">
            <Form className="siteformbg">
              ...
              <div className="tabrightbox">
                    <Link href="/transferhistory" className="btn borderbtn btn-sm" id="backbtn">View More</Link>
                </div>
              <div className="panelcontentbox">
