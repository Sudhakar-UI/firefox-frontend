...
const DepthChart = () => 
{
  useLayoutEffect(() => {
        ...
        xAxis.get("renderer").labels.template.setAll({
          fill: am5.color(0x6C6C6C), // Replace 0x0000ff with the desired color code
        });
        ...
        yAxis.get("renderer").labels.template.setAll({
          fill: am5.color(0x6C6C6C), // Replace 0x00ff00 with the desired color code
        });
        // Add series
