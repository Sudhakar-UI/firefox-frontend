...
const page = () => {
    ...
    return (
        <>
            <section className="fivehunderderror">
                <Container className="sitebannercontent">
                    <Row className="align-items-center">
                        <Col lg={12} md={12} sm={12}>
                            <div className="d-flex justify-content-center">
                                <Image src="assets/images/fivehinderd-white.png" className="fivehund-img lightthemeicon" alt="icon" width={100} height={100} />
                                <Image src="assets/images/fivehunderd-dark.png" className="fivehund-img darkthemeicon" alt="icon" width={100} height={100} />
                            </div>
                        </Col>
                    </Row>
                </Container>
