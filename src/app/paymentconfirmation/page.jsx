                                ...
                                <div className="paytspsbg ">
                                    <div className="paymentspsbg paymntspbg-y">
                                        <div className='d-flex justify-content-center mt-4 mb-3'>
                                            <Image src="assets/images/payment-confirmation.svg" width={100} height={100} alt="logo" className="lightthemeicon" />
                                            <Image src="assets/images/payment-confirmation.svg" width={100} height={100} alt="logo" className="darkthemeicon" />
                                        </div>
                                        <h5 className="text-center mt-4">
                                            Payment Confirmation
                                        </h5>
                                        <p className="mt-3 text-center">
                                            Thank you! Your payment has been received successfully. The amount will be reflected in your account within the next few minutes. If you have any questions or need assistance, feel free to contact our support team.
                                        </p>
                                        <div className='text-center mt-2 mb-1'>
                                            <Link href="/" className='btn sitebtn'>Go Back</Link>
                                        </div>
