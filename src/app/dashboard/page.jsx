				...
				<Container className="sitecontainer dashboardpage">
					<div className="flexbox">
								...
								<div className="overviewbalancebox">
									<div className="securepanelbox">
										<div className="balanceshowt totblance d-flex align-items-center">
											<div>
												<h5>Total funds</h5>
												<h4 className="h4"><span className='funds-value-x'>$ 648,406,178.68</span>
								...
								<Tab.Container defaultActiveKey="personalbalance">
									<div className="innerpagetab">
										<Nav className="nav nav-tabs tabbanner justify-content-center" role="tablist">
											<Nav.Item className="nav-item"><Nav.Link eventKey="personalbalance">Personal Balance</Nav.Link></Nav.Item>
											<Nav.Item className="nav-item"><Nav.Link eventKey="businessbalance">Business Balance</Nav.Link></Nav.Item>
										</Nav>
									</div>
									<Tab.Content>
						...
						<div className="panelcontentbox purchasetable mobilepaneltablebox">
							...
							<Tab.Container defaultActiveKey="personalasset">
								...
								<Tab.Content>
									<Tab.Pane eventKey="personalasset">
										<div className="bordertablebox">
											<SimpleBar className="table-responsive sitescroll myasttable-y">
												...
												<td colSpan={4}>
													...
													No record found
														...
														<tr>
															...
															<td>$23.72</td>
															<td><div className="prgrsbar-y prgrsflx"><div>40%</div><div><ProgressBar variant="success" now={40} /></div></div></td>
														</tr>
														<tr>
															<td><Image src="assets/images/color/eth.svg" width={50} height={50} alt="coin" className="coinlisticon" />ETH</td>
															<td className="breaktagtd"><b>0.293985</b><br /><span className="t-gray">≈$0.00</span></td>
															<td>$23.72</td>
															<td><div className="prgrsbar-y prgrsflx"><div>0%</div><div><ProgressBar variant="success" now={0} /></div></div></td>
														</tr>
														<tr>
