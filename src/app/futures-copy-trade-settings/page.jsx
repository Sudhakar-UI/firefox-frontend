...
import { faAngleDown, faExchange, faEye, faChevronDown, faCaretDown, faCaretUp } from '@fortawesome/free-solid-svg-icons';


const FuturesTradeCopy4 = () => {
    useEffect(() => {
        ...
        <>
            <div className='cpytrade'>
                ...
                <section className="innerpagecontent copytradetopsection savingbannersec ieobannerbg">
                    <Container className="container">
                        <h2 className="heading-title mb-0 pb-0">Futures Copy Settings</h2>
                    </Container>
                </section>
                ...
                <section className="copytradecntsection">
                    <Container>
                        <div className="twotablesec">
                            <Nav activeKey='/futures-copy-trade-3' className="nav nav-tabs border-0" role="tablist">
                                <Nav.Item className="nav-item"> <Nav.Link id='futtab' className="nav-link nav-link-y-pnl" href="/futures-copy-trade-3">Futures</Nav.Link> </Nav.Item>
                                <Nav.Item className="nav-item"> <Nav.Link id='spottab' className="nav-link nav-link-y-pnl" href="/spot-copy-trade-4">Spot</Nav.Link> </Nav.Item>
                            </Nav>
                        </div>
                                            ...
                                            <div className="flexbox align-items-center">
                                                <div className="profileleftb">
                                                    <div className="d-flex prflex gap-2">
                                                        <div> <span className="profileicon"><Image alt='proficon' width={20} height={20} src="assets/images/profile1.svg" /></span>
                        ...
                        <h5 className="modal-title">
                            <div className="twotablesec smallboxtab">
                                <Nav variant='tabs' className="nav nav-tabs border-0" role="tablist">
                                    <Nav.Item className="nav-item">
                                        <Nav.Link id='add' className="nav-link nav-link-y-pnl" eventKey="addwallet">Add</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="nav-item">
                                        <Nav.Link id='remove' className="nav-link nav-link-y-pnl" eventKey="removewallet">Remove</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                            </div>
                        </h5>
                                ...
                                <Form className="siteformbg">
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <InputGroup className="input-group">
                                            <FormControl type="text" id='amount' className="form-control" placeholder="Input amount" />
            ...
            <Modal className=" pairmdlbox" show={showCopy} onHide={handleHideCopy} centered aria-hidden="true">
                <Modal.Header closeButton>
                    ...
                    {/* <Button type="button" onClick={handleHideCopy} className="close" data-bs-dismiss="modal"><span>&times;</span></Button> */}
                </Modal.Header>
                <Modal.Body className="modal-body pt-2">
                    <div className="d-flex gap-2 pt-2 text-center justify-content-center">
                        <Button type="button" className="btn sitebtn btn-sm" data-bs-dismiss="modal">No</Button>
                        <Button type="button" className="btn sitebtn btn-sm" id="yes">Yes</Button>
                    </div>
                </Modal.Body>
            </Modal>
        </>
...
export default FuturesTradeCopy4;