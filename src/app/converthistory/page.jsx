...
import { faQrcode, faExchange, faArrowUp, faArrowDown, faArrowsRotate } from '@fortawesome/free-solid-svg-icons';
            ...
            <Container className="sitecontainer">
                ...
                <div className="boxtabb tabrightbox">
                        <Nav className="nav nav-tabs tabbanner border-0" role="tablist">
                            ...
                            <Nav.Item className="nav-item"><Nav.Link href="/converthistory" className="active">Convert</Nav.Link></Nav.Item>
