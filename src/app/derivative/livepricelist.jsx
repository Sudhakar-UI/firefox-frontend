        ...
        <ul className="livepricenavbg">
          <li>
            <span className="markettabdropbox">
              <NavDropdown title={ <div className="pull-left"> <Image src="assets/images/color/btc.svg" className="coinlisticon" alt="coin" /> BTC/USD <span className="t-gray cointxt">Futures</span> </div> }  id="basic-nav-dropdown"
