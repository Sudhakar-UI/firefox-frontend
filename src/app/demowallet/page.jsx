...
import { Container, Image, Table, Button, Form, Nav, Row, Col, Modal, NavDropdown, ProgressBar, faEdit } from 'react-bootstrap';
		...
		<div className="pagecontent gridpagecontent innerpagegrid">
			...
			<div className="innerpagecontent">
				<Container className="sitecontainer">
					<h2 className="h2">Demo Wallet</h2>
					<div className="boxtabb tabrightbox">
						<Nav className="nav nav-tabs tabbanner border-0" role="tablist">
							<Nav.Item className="nav-item"><Nav.Link as={Link} href="/spotwallet">Spot</Nav.Link></Nav.Item>
								<Nav.Item className="nav-item"></Nav.Item> 
							<Nav.Item className="nav-item"><Nav.Link as={Link} href="/featureswallet">Features</Nav.Link>
							</Nav.Item>
								<Nav.Item className="nav-item"><Nav.Link as={Link} href="/demowallet" className="active">Demo wallet</Nav.Link>
							</Nav.Item>
						</Nav>
					</div>
				</Container>
					...
					<div className="panelcontentbox">
						<div className="wlltpageblnce">
							<div className="balanceshowt totblance d-flex align-items-center">
								<div>
									<h5>Spot balances<span className="ps-2"><FontAwesomeIcon icon={faEye} /></span></h5>
								...
								<Table className="sitetable table-responsive-stack historytable" id="table1">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<Link href="/personalsend" className="btn sitebtn btn-sm me-1">Edit</Link>
											{/* <Link href="/personalreceive" className="btn borderbtn red-btn btn-sm">Receive</Link> */}
											</td>
										</tr>
										<tr>
